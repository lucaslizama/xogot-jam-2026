...
@export_range(200.0, 20000.0, 50.0) var full_power_flick: float = 13000.0
...
@export_range(0.2, 2.0, 0.05) var power_curve: float = 0.95
...
@export_range(0.0, 1.0, 0.01) var min_power: float = 0.16
...
@export_range(0.0, 400.0, 1.0) var spin_curve: float = 120.0
