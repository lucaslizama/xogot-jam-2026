...
@export_range(1.0, 200.0, 0.5) var gravity: float = 42.0
## Height the pizza leaves the rider's hands at.
@export_range(0.0, 10.0, 0.1) var release_height: float = 2.2
...
@export_range(0.0, 60.0, 0.5) var max_aim_speed: float = 14.0
...
@export_range(0.0, 400.0, 1.0) var spin_curve: float = 26.0
